...
set_property -dict {LOC T11  } [get_ports qsfp2_mgt_refclk_0_p] ;# MGTREFCLK0P_232 from U104.13
...
set_property -dict {LOC AH2  } [get_ports {pcie_rx_p[2]}]  ;# MGTYTXN1_227 GTYE3_CHANNEL_X0Y5 / GTYE3_COMMON_X0Y1
